...
def render_plots():
    ...
    with col1:
         ...
         plot1 = {'MATERIALES EMITIDOS SIN DEPARTAMENTO': df_frequency}
         engine_plot1 = engine(
                        plot1,
                        'pie',
                        x_axis='MATERIAL',
    ...
    with col2:
         plot2 = {'Inversión Histórica en Adquisiciones por Proveedor': df_financial}
         engine_plot2 = engine(
                        plot2,
                         'bar',
                         'SUPPLIER',
    ...
    with col3:
         plot3 ={'Valor económico de materiales entregados por cada departamento': df_economic_impact_by_department}
